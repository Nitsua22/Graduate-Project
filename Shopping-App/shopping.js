                        ...
                        if (err1) {
                            ...
                            if (result1[1].length > 0) {
                                ...
                                result1[1].forEach(function (r) {
                                    ...
                                    receipt['card_number'] = r['card_number'];
...
app.post('/checkout', requireLogin, function (req, res) {
    ...
    if (!req.session.cart) {
        ...
        receipt['cart'] = cart;
        receipt['payment_method'] = req.body.payment_card_num;
        ...
        // save receipt
        var query = " USE shopdb; INSERT INTO receipts(card_number,shipping_address,shipping_recipient,items,subtotal, grandtotal, appuser_id) VALUES('" + receipt['payment_method'] + "','" + receipt['shipping_address'] + "','" + receipt['shipping_recipient'] + "','" + JSON.stringify(receipt['item_list']) +
