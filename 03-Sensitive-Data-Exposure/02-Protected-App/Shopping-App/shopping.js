...
app.post('/checkout', requireLogin, function (req, res) {
    ...
    if (!req.session.cart) {
        ...
        // save receipt
        var query = " USE shopdb; INSERT INTO receipts(card_number,shipping_address,shipping_recipient,items,subtotal, grandtotal, appuser_id) VALUES('" + receipt['shipping_address'] + "','" + receipt['payment_method'] + "','" + receipt['shipping_recipient'] + "','" + JSON.stringify(receipt['item_list']) +
