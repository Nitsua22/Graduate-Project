/*   
    ...
    3.3.5.2	Shopping App
        The shopping application will be modified in the following ways to expose the vulnerability:
        1.	A new feature shall be added to allow a user to navigate to a page called ‘receipts’ that allows a user to look up receipts.
        a.	The page shall include static text which indicates the user’s ID or username
        b.	The page shall include a button to ‘get receipts’, which will request all of the receipts from the back-end system, and display them on the front end
        c.	The application shall accept the user_id from the front end of the application instead of the user’s session when performing the receipt search   
*/
