        ...
        if (err) {
            ...
            if (result[1].length > 0) {
                ...
                if (!req.query['date_from']) {
                    ...
                    // SCP: no longer using the value gotten from the front end
...
// SCP: checking whether the userID matches the sessionID before allowing the query
...
app.all("/register", function (req, res) {
    ...
    if (Object.keys(req.body).length === 0) {
        ...
        if (vulnerable) {
            ...
            user[0] = xssFilters.inHTMLData(req.body.username);
            user[1] = xssFilters.inHTMLData(req.body.password);
            user[2] = xssFilters.inHTMLData(req.body.firstname);
            user[3] = xssFilters.inHTMLData(req.body.lastname);
            user[4] = xssFilters.inHTMLData(req.body.address);
        }
