...
# not sure if we want to use carts in the db yet or just make them cookiez 
#CREATE TABLE carts
#(
#    id SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY
#    , appuser_id SMALLINT UNSIGNED NOT NULL UNIQUE
#    , contents JSON # https://dev.mysql.com/doc/refman/8.0/en/json.html
#    , FOREIGN KEY fk (appuser_id) REFERENCES appusers (id)
#        ON DELETE CASCADE
#        ON UPDATE RESTRICT   
#);
